...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\0cifar\\cifar10_cat_train_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials_4 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('cifar10png/cat_train.xlsx', selection='0:1000'),
    ...
    trials_5 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('cifar10png/cat_train.xlsx', selection='1001:2000'),
    ...
    trials_6 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('cifar10png/cat_train.xlsx', selection='2001:3000'),
    ...
    trials_7 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('cifar10png/cat_train.xlsx', selection='3001:4000'),
    ...
    trials_8 = data.TrialHandler(nReps=1.0, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('cifar10png/cat_train.xlsx', selection='4001:5000'),
